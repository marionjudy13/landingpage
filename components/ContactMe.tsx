    ...
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-x-7xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-10">
        <h4 className="text-4xl font-semibold text-center">
          I've got just watcha need.{" "}
          <span className="underline decoration-pink/50">Let's talk.</span>
        </h4>
        ...
        >
          ...
          <button
            type="submit"
            className="bg-pink py-5 px-10 rounded-md text-black font-bold text-xl"
          >
            Submit
          </button>
        </form>
